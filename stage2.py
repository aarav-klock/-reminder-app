...
t.geometry("500x300")
t.iconbitmap(r'D:\CU\Sem 1\Introduction to Python programming\Reminder app\ico.ico')
...
def meeting_win():
    ...
    new.iconbitmap(r'D:\CU\Sem 1\Introduction to Python programming\Reminder app\ico.ico')
